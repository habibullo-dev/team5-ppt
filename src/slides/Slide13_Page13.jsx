...
const Slide13_Page13 = () => {
    return (
        <div className="h-full flex flex-col">
            ...
            {/* Content Area */}
            <div className="flex-1 rounded-3xl border border-white/10 relative group min-h-0 flex items-center justify-center bg-[#1E1C1B] overflow-hidden">

                {/* Central Diagram Container - Using grid/flex for stability but layout similar to image */}
                <div className="relative w-full h-full max-w-6xl mx-auto p-12 flex flex-col items-center justify-center">

                    {/* Top Row Text */}
                    <div className="w-full flex justify-between absolute top-[15%] px-12 md:px-24">
                    ...
                    <div className="relative flex flex-col items-center z-10 w-full max-w-4xl">
                        <img
                            ...
                            className="w-full h-auto object-contain max-h-[40vh] drop-shadow-2xl"
                        />
                        <h3 className="text-3xl md:text-4xl font-bold text-white mt-8 tracking-wide">주행품질 유지 및 시스템 단순화</h3>
                    </div>

                    {/* Bottom Row Text */}
                    <div className="w-full flex justify-between items-end absolute bottom-[15%] px-8 md:px-16">
